...
public class CircleIndicators extends LinearLayout implements OnPageChangeListener {
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorWidth =
                typedArray.getDimensionPixelSize(R.styleable.CircleIndicators_aci_width, -1);
        mIndicatorHeight =
                typedArray.getDimensionPixelSize(R.styleable.CircleIndicators_aci_height, -1);
        mIndicatorMargin =
                typedArray.getDimensionPixelSize(R.styleable.CircleIndicators_aci_margin, -1);

        mAnimatorResId = typedArray.getResourceId(R.styleable.CircleIndicators_aci_animator,
                R.animator.scale_with_alpha);
        mAnimatorReverseResId =
                typedArray.getResourceId(R.styleable.CircleIndicators_aci_animator_reverse, 0);
        mIndicatorBackgroundResId =
                typedArray.getResourceId(R.styleable.CircleIndicators_aci_drawable,
                        R.drawable.white_radius);
        mIndicatorUnselectedBackgroundResId =
                typedArray.getResourceId(R.styleable.CircleIndicators_aci_drawable_unselected,
                        mIndicatorBackgroundResId);
        typedArray.recycle();
    }
